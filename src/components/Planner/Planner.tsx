...
import downloadItinerary from "../../helpers/download.ts";
...
const Planner: React.FC = () => {
  ...
  const createItineraryCall = async () => {
    ...
    setIsLoading(true);
    setError(null);
    const template = `Plan me an itinerary for this place ${place} for ${days} days with give output like start point(with duration,travel method and activity) then similary for second point then for third point similary for all stops.\n${additionalInfo ? 'Additional instructions: ' + additionalInfo : ''}`;
  ...
  return (
    <div className="container mx-auto p-4 max-w-4xl">
      <header className="text-center mb-8">
        <h1 className="text-4xl font-bold text-blue-600">Travel Guide</h1>
        <p className="text-gray-600">Design your ideal escape with the help of AI</p>
      </header>
